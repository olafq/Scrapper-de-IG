...
usuariosDeInstagram = contar_archivos_txt("C:\\Users\\querolol\\Desktop\\Proyecto_RRSS\\webScrapper\\WebScraperDanone\\instagram\\instagramUser" )
...
for i in (1,usuariosDeInstagram):
    #usuarios_a_buscar
    ruta_completa = os.path.join(os.getcwd(), "C:\\Users\\querolol\\Desktop\\Proyecto_RRSS\\webScrapper\\WebScraperDanone\\UsuariosABuscar.txt")
    ...
    ruta_completa = os.path.join(os.getcwd(), "C:\\Users\\querolol\\Desktop\\Proyecto_RRSS\\webScrapper\\WebScraperDanone\\instagram\\instagramUser\\instagramUser"+ str(i) +".txt")
